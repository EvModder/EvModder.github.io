...
function YouTubeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 29 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        fillRule="evenodd"
        d="M14.4848 20S23.5695 20 25.8229 19.4C27.0917 19.06 28.0459 18.08 28.3808 16.87C29 14.65 29 9.98 29 9.98S29 5.34 28.3808 3.14C28.0459 1.9 27.0917.94 25.8229.61C23.5695 0 14.4848 0 14.4848 0S5.42037 0 3.17711.61C1.9286.94.954148 1.9.59888 3.14C0 5.34 0 9.98 0 9.98s0 4.67.59888 6.89c.355268 1.21 1.32972 2.19 2.57823 2.53C5.42037 20 14.4848 20 14.4848 20ZM19 10l-7.5-4.25v8.5L19 10Z"
      />
    </svg>
  );
}
